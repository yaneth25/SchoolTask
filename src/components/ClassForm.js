...
function createThemedStyles(colors, borders) {
...
function TimeField({ label, value, onChange, error, styles }) {
...
function DayPicker({ value, onSelect, error, styles }) {
...
export default function ClassForm({
  ...
  const styles = useMemo(
    () => createThemedStyles(colors, borders),
    [colors, borders],
  );
  ...
  return (
    ...
    >
      ...
      {showDayPicker ? (
        <DayPicker value={day} onSelect={setDay} error={errors.day} styles={styles} />
      ) : null}
